...
import ex1.com.cg.eis.dao.DaoClass;
import ex1.com.cg.eis.dao.IDao;
import ex1.com.cg.eis.utils.MyException;
...
public class EmployeeService implements IEmployeeService {
	...
	public boolean desgnvalid(String quan) {
		// TODO Auto-generated method stub
		try {
			if (quan.equals("System Associate") || quan.equals("Manager") || quan.equals("Clerk")
					|| quan.equals("Programmer"))
				return true;
			else
