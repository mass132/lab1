...
/*
 * CollectionUtil contains the storage related informations,and methods
 */
public class CollectionUtil {
	private static Map<Integer, Product> products = new HashMap<Integer, Product>();//Stores the product information
	static {
	...
	public static Map<Integer, Product> getProducts() { //Returns the products 
		return products;
	}
